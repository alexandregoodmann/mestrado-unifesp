...
\tituloPT{Modelo de teses e dissertações em LaTeX do ICT-UNIFESP}
\tituloEN{Model of theses and dissertations in LaTeX of the ICT-UNIFESP}
\autor[de Tal, Fulano]{Fulando de Tal}
\genero{M} % Gênero do autor (M = Masculino / F = Feminino)
\orientador[Orientador]{Prof. Dr.}{Beltrano da Silva}
%\coorientador{Prof. Dr.}{Fulano de Tal}
\curso{PPGCC}
\data{01}{09}{2022} % Data do depósito
...
\textoresumo[brazil]{
    Este trabalho é um breve modelo  para a escrita de monografias de qualificação, dissertações e teses utilizando o ambiente \LaTeX, de acordo com as normas exigidas pelo Instituto de Ciência e Tecnologia (ICT), da Universidade Federal de São Paulo (UNIFESP). Para a confecção deste modelo foi utilizado a última versão (1.9.6) do pacote de classes \textit{abnTeX2} que segue as normas da Associação Brasileira de Normas Técnicas. A elaboração de uma monografia, dissertação ou tese pode ser feita sobrescrevendo o conteúdo deste modelo. 
